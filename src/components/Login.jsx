...
const Login = () => {
    ...
    // submit button not working so please check it
        ...
        <div className='w-full max-w-sm mx-auto bg white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className='mb-4'>
                    ...
                    type="email" id='email' placeholder='Email Address' className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline'/>
                </div>
                ...
                <div>
                    <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded focus:outline-none focus:shadow-outline' type='button'>Login</button>
                </div>
            </form>
