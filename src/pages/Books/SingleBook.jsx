...
const SingleBook = () => {
  ...
  if(isError) return <div>Error in loading book information</div>
  return (
    <div className="max-w-lg shadow-md p-5">
     ...
     <div className=''>
      <div>
        ...
        <div className='mb-5'>
          <p className='text-gray-600 mb-5'><strong>Author:</strong> {book.author|| 'admin'}</p>
          <p className='text-gray-600 mb-4'><strong>Published:</strong> {new Date(book?.createdAt).toLocaleDateString()}</p>
          <p className='text-gray-600 mb-4 capitalize'><strong>Category:</strong> ${book?.category}</p>
